...
## Generelle Entwicklung des TEN SING Netzwerks über die Jahre

Hier soll ein Einblick entstehen, wie sich das TEN SING Netzwerk über die Jahre hinweg verändert..

### Anzahl der Ortsgruppen

::: {.panel-tabset}
## Deutschlandweit
Dieses Diagramm zeigt, wie sich die Anzahl der TEN SING Ortsgruppen in Deutschland im Laufe der Jahre verändert hat.
...
Hier seht ihr, welche Themen dem TEN SING Netzwerk über die Jahre wichtig sind bzw. wie sich die Sicht auf bestimmte Themen verändert.
...
asis_output(callout_datenquellen(all_data[[1]]$cfg,tn_q=list("Q_BEGIN_AUSSAGEN_LIKERT")))
```


## Wirkung der PG über die Jahre

Hier seht ihr wie die Arbeit der PG über die Jahre hinweg wahrgenommen wird.
...
#### Teilnehmendenzahlen bei DE-Veranstaltungen
